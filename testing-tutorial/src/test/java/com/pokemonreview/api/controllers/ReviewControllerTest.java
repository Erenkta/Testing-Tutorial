...
public class ReviewControllerTest {
    ...
    @Test
    public void ReviewController_CreateReview_ReturnReviewDtoAnd201() throws Exception {
        int pokemonId = 1;
    ...
    @Test
    public void ReviewController_DeleteReview_ReturnReviewDto() throws Exception {
        int pokemonId = 1;
        int reviewId = 1;
